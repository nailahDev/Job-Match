...
var personality_insights = watson.personality_insights({
  username: '525d23f7-d80a-45b2-abde-dafca552ff1d',
  password: 'bAWedyDOEUcl',
...
var Twithelper = new Twit({
  consumer_key: '1MLlXCYxPYyFa6oEecRtM1mMt',
  consumer_secret: 'ZuTUwHlBIP0jVkxRF7htwne2LZPeeoQo7E442WXbXG9aBbVGK4',
  app_only_auth: true
})
...
var me = 'Nailah'; // Set this to your own account
var password = process.env.cloudant_password;

// Initialize the library with my account.
var cloudant = Cloudant({account:me, password:});
